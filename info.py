...
BOT_TOKEN = environ.get('BOT_TOKEN', "7643849694:AAGdXtSISJFATSnPIrn73xHlY6LPxHD3Stw")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/9Ob.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1170337923,5849986145').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002005256627'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002382454893') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002238938415')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002142979617')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://botking:botking@cluster0.x6v8i.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/tfirequestgroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/tfi_oficial')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'tfirequestgroup') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/tfi_oficial')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://adv2.onrender.com")
